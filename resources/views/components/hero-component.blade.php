    ...
    <div class="container">
        <div class="py-4 d-flex logout justify-content-center gap-5">
            ...
            <div class="profile-btn-group d-flex gap-3" role="group" aria-label="Basic example">
                ...
                <a href="{{route('gallery.index')}}" class="link-light link-offset-2 link-underline-opacity-0"><button type="button" class="btn btn-light text-primary rounded-0 border-2 fw-bold border border-primary btn-box1">Gallery</button></a>
                <a href="{{url('/search')}}" class="link-light link-offset-2 link-underline-opacity-0"><button type="button" class="btn btn-light rounded-0 text-primary fw-bold border-2 border border-primary btn-box1">Search</button></a>
            </div>
        </div>
    </div>
</div>