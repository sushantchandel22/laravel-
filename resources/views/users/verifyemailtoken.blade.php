    ...
    <div class="container login-form">
        ...
        <div class="row align-items-center justify-content-center g-1 gap-2">
            ...
            <div class="col col-sm-12 col-lg-4 form">
                ...
                @endif
                <form method="post" action="{{ route('check.emailtoken') }}">
                    @csrf
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label text-secondary fw-bold fs-6">Verification
                                Code</label>
                            <div class="login-input border d-flex p-2 align-items-center">
                                ...
                                <input type="password" class="form-control d-block fs-5 rounded-0  input border border-0"
                                    aria-describedby="emailHelp" name="token" placeholder="Enter passwords">
                        ...
                        {{-- <div class="mb-3 form-check py-2">
                            ...
                            <a href="" class="ms-3">Resend Token</a>
                        </div> --}}
                        <button
                            type="submit"class="btn btn-primary rounded-0 btn-lg login-form-btn rounded-1 form-btn fw-bold border-0">Verify
                            Token</button>
