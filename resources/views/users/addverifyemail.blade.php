    ...
    <div class="container login-form">
        ...
        <div class="row align-items-center justify-content-center g-1 gap-2">
            ...
            <div class="col col-sm-12 col-lg-4 form">
                 ...
                 @endif
                <form method="post" action="{{ route('addverifyemail')}}">
                @csrf
                    <div class="d-flex justify-content-center align-items-center flex-column">
                       
                          
                        <h3 class=" fs-2 fw-bold">Verify Your Email</h3>
                        <div class="mb-3">
                        ...
                        {{-- <div class="mb-3">  
                            <label for="exampleInputPassword1" class="form-label text-secondary fw-bold fs-6">Verification Code</label>
                            <div class="login-input border d-flex p-2 align-items-center">   
                                <img src="{{ asset('assets/images/loginimages/Suche (1).png') }}" class=" login-logo mx-1" alt="" height="14" width="26">
                                <input type="password" class="form-control d-block fs-5 rounded-0  input border border-0" aria-describedby="emailHelp" name="token" placeholder="Enter passwords">
                                <img src="{{ asset('assets/images/loginimages/Suche (2).png') }}" class="toggle-password ms-auto ps-2" alt="">
                        ...
                        <button type="submit"class="btn btn-primary rounded-0 btn-lg login-form-btn rounded-1 form-btn fw-bold border-0">Verify Token</button>
                        ...
                        {{-- <button type="button" onclick="window.location='{{ route('google-auth-login') }}'" class="btn text-black fw-bold fs-5 btn-outline-secondary rounded-1 mt-3 btn-lg form-btn">
                            <img src="{{ asset('assets/images/loginimages/icons8-google-48.png') }}" alt="" height="28">
                            Continue with Google
                        </button> --}}
                        ...
                        {{-- <div class="pt-3 ">
                            <p class="text-black fw-bold fs-5">Don't have an account yet? <a href="{{url('/signup')}}" class="link-primary link-offset-2 fw-bold link-underline-opacity-0">Sign Up</a></p>
                        </div> --}}
                    </div>
